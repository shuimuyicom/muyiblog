...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'shuimuyi', // 您的昵称 例如 shuimuyi
  BIO: process.env.NEXT_PUBLIC_BIO || '产品经理丨哲学硕士｜中华国学探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.shuimuyi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'shuimuyi, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hello, my name is Shuimuyi. I am a product manager, philosophy master, and Chinese philosophy explorer.',
