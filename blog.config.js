...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '水木易', // 您的昵称 例如 shuimuyi
  BIO: process.env.NEXT_PUBLIC_BIO || '产品经理，哲学硕士，国学命理探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.shuimuyi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '水木易,博客,哲学,国学,命理', // 网站关键词 英文逗号隔开
